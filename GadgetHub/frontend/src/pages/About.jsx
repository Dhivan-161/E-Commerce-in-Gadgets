...
const TEAM = [
  { name: 'Irfan', role: 'CEO & Founder', avatar: 'A', color: '#2563EB' },
  { name: 'Hashina', role: 'Head of Products', avatar: 'S', color: '#06B6D4' },
    ...
    <Box>
      ...
      <Box
        ...
        <Container maxWidth="md">
          <Typography variant="h3" sx={{ fontWeight: 800, mb: 2 }}>About 1% Battery</Typography>
      ...
      <Container maxWidth="md" sx={{ py: 8, textAlign: 'center' }}>
        ...
        <Typography variant="body1" color="text.secondary" sx={{ lineHeight: 1.9, fontSize: '1.1rem' }}>
          At 1% Battery, we believe everyone deserves access to the best technology. That's why we work directly with leading manufacturers to bring you authentic products at fair prices. From flagship smartphones to premium audio gear — we've got you covered.
        </Typography>
        <Divider sx={{ my: 4 }} />
        <Typography variant="body1" color="text.secondary" sx={{ lineHeight: 1.9, fontSize: '1.1rem' }}>
      ...
      <Box sx={{ bgcolor: 'background.paper', py: 6 }}>
        <Container maxWidth="lg">
          ...
          <Typography color="text.secondary" sx={{ textAlign: 'center', mb: 4 }}>The people behind 1% Battery</Typography>
